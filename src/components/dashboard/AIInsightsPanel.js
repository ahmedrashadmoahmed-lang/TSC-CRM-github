...
export function AIInsightsPanel() {
    ...
    const renderFollowUps = () => (
        <div className={styles.content}>
            {['high', 'medium', 'low'].map((priority) => {
                const suggestions = data.followUpSuggestions[priority];
    ...
    const renderOpportunities = () => (
        <div className={styles.content}>
            {!data.highPotentialOpportunities || data.highPotentialOpportunities.length === 0 ? (
    ...
    const renderNotes = () => (
        <div className={styles.content}>
            <div className={styles.notesList}>
                {data.performanceNotes && data.performanceNotes.map((note, index) => (
